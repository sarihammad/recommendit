#!/usr/bin/env python3
"""Training script for movies domain."""
...
def main():
    """Main training function for movies domain."""
    domain = 'movies'
    logger.info("Starting training for movies domain")
    ...
    try:
        ...
        content_features = content_feature_extractor.fit_transform(movies_df)
        ...
        user_feature_extractor.fit(train_data, movies_df)
